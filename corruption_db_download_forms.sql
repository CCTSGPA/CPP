...
DROP TABLE IF EXISTS `download_forms`;
...
CREATE TABLE `download_forms` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKgrodo655verp7kbyea0rfd5x6` (`uploaded_by`),
  CONSTRAINT `FKgrodo655verp7kbyea0rfd5x6` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`)
...
LOCK TABLES `download_forms` WRITE;
/*!40000 ALTER TABLE `download_forms` DISABLE KEYS */;
/*!40000 ALTER TABLE `download_forms` ENABLE KEYS */;
UNLOCK TABLES;
